...
Food.prototype.init = function(){
	...
	ctx.clearRect(this.x + offerX,this.y + offerY,30,28);
...
Food.prototype.draw = function(){
	...
	if(frame % 2) 
	{
		ctx.drawImage(img,30 * this.type + images[this.src][0], images[this.src][1], 30, 28, this.x + offerX, this.y + offerY, 30, 28) ;
	}	
	else 
	{
		ctx.clearRect(this.x + offerX,this.y + offerY,30,28);
