...
MyTank.prototype.draw = function(canvas){
	...
	ctx.drawImage(img, 32 * this.dir + tankx, tanky, 32, 32, this.x + offerX, this.y + offerY, 32, 32) ;	
		
	
	if(this.isGod)
	{
		var fr = parseInt(this.godTime / 6 )% 2;
		ctx.drawImage(img, shieldx, fr * 32 + shieldy, 32, 32, this.x + offerX, this.y + offerY, 32, 32) ;
	}
...
Tank3.prototype.draw = function(canvas){
	...
	ctx.drawImage(img, 32 * this.dir +(3 - this.life) * 128 + images["tank3"][0], images["tank3"][1], 32, 32, this.x + offerX, this.y + offerY, 32, 32) ;	
};
